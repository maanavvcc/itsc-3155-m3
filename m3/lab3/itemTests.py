...
def test_calculate_item_total_price_converts_discount(expected_discount: float = 0.2) -> tuple[bool, str]:
    ...
    percentOfActual = totalItemPrice/(item.unit_price * item.quantity)
    actual_discount = 1 - percentOfActual
    actual_discount = round(actual_discount,2)

    fail_case = (expected_discount - actual_discount != 0)  # Replace None with the correct code
...
def test_calculate_item_total_price_correct() -> tuple[bool, str]:
    ...
    # - Run the test before implementing the calculate_item_total_price method and check that it fails
    # - TIP: Use the round function to round the result to 2 decimal places
    item = Item("item", 1, 3.0, discount_percent=.2)  # Replace None with the correct code
    ...
    fail_case = (expected_item_price - actual_item_price != 0)  # Replace None with the correct code
